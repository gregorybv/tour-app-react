...
const Gallery = () => {
  return (
    <section className='gallery container'>
      <div className='gallery__hat' data-aos='zoom-in' data-aos-duration='1500'>
        <h2 className='gallery__title title-h2'>Фотографии путешествий</h2>
      ...
      <div className='gallery__block'>
        <ul className='gallery__pictures'>
          <li>
            <img className='gallery__img' src={travel_1} alt='Gallery' />
          </li>
          <li className='gallery__block_hidefirst'>
            <img className='gallery__img' src={travel_2} alt='Gallery' />
          </li>
          <li className='gallery__block_hidesecond'>
            <img className='gallery__img' src={travel_3} alt='Gallery' />
          </li>
          <li>
            <img className='gallery__img' src={travel_4} alt='Gallery' />
          </li>
        </ul>
        <ul className='gallery__picture'>
          <li>
            <img className='gallery__image' src={travel_5} alt='Gallery' />
          </li>
          <li className='gallery__block_hidesecond'>
            <img className='gallery__image' src={travel_6} alt='Gallery' />
          </li>
          <li className='gallery__block_hidefirst'>
            <img className='gallery__image' src={travel_7} alt='Gallery' />
          </li>
          <li>
            <img className='gallery__image' src={travel_8} alt='Gallery' />
          </li>
          <li>
            <img className='gallery__image' src={travel_13} alt='Gallery' />
          </li>
        </ul>
        <ul className='gallery__pictures'>
          <li>
            <img className='gallery__img' src={travel_9} alt='Gallery' />
          </li>
          <li>
            <img className='gallery__img' src={travel_10} alt='Gallery' />
          </li>
          <li className='gallery__block_hidesecond'>
            <img className='gallery__img' src={travel_11} alt='Gallery' />
          </li>
          <li className='gallery__block_hidefirst'>
            <img className='gallery__img' src={travel_12} alt='Gallery' />
          </li>
        </ul>
      </div>
    </section>
