...
const Tour = () => {
  return (
    <section id='tour' className='tour container'>
      <div className='tour__hat' data-aos='zoom-in' data-aos-duration='1500'>
      ...
      <div className='tour__forms'>
        <form
          name='form'
          className='tour__form'
          action='src/components/Blocks/Tour/Tour#'
        >
            ...
            <div className='tour__item'>
              <label className='tour__label'>
                ...
                <select className='tour__input'>
                  <option value='Куда хотите ехать' className='tour__input'>
                    Куда хотите ехать
                  </option>
                  <option value='Туда' className='tour__input'>
                    Туда
                  </option>
                  <option value='Сюда' className='tour__input'>
                    Сюда
                  </option>
                  <option value='Отсюда' className='tour__input'>
                    Отсюда
                  </option>
                </select>
              </label>
          ...
          <div className='tour__age'>
            <label className='tour__label'>Вам есть 18 лет?</label>
          ...
          <div className='tour__licenses'>
            <label className='tour__license'>
              <input type='checkbox' className='tour__license_input' />
              <span className='tour__checkbox'></span>
              Нажимая кнопку, я принимаю условия
              <a
                href='src/components/Blocks/Tour/Tour#'
                className='tour__license_link'
              >
