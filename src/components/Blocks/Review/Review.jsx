...
const Review = () => {
  return (
    <section id='review' className='review container'>
      <div className='review__hat' data-aos='zoom-in' data-aos-duration='1500'>
        ...
        <li className='review__column'>
          ...
          <div className='review__author'>
            <div className='review__frame'>
              ...
              <p className='review__subtext'>Тур: Вдали от дома</p>
            </div>
            <img className='review__img' src={review_1} alt='Author' />
          </div>
        </li>
        <li className='review__column'>
          <p className='review__text'>
          ...
          <div className='review__author'>
            <div className='review__frame'>
              ...
              <p className='review__subtext'>Тур: Путешествие в горы</p>
            </div>
            <img className='review__img' src={review_2} alt='Author' />
          </div>
        </li>
      </ul>
    </section>
