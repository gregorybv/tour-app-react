  ...
  return (
    <section id='stories' className='story'>
      <div className='story__container'>
        <div className='story__hat' data-aos='zoom-in' data-aos-duration='1500'>
          <h2 className='story__title title-h2'>Истории путешествий</h2>
        ...
        <ul className='story__blocks'>
          <li className='story__content'>
            <div className='story__body'>
              <h3 className='story__text'>Автостопом в Стамбул</h3>
            ...
            <div className='story__footer'>
              <button type='button' className='story__button button'>
                Подробнее
                <img className='story__icon' src={arrow} alt='arrow' />
              </button>
            ...
            <img className='story__image' src={story_1} alt='story photo-1' />
          </li>
          <li className='story__content'>
            <div className='story__body'>
              <h3 className='story__text'>Автостопом в Стамбул</h3>
            ...
            <img className='story__image' src={story_2} alt='story photo-2' />
          </li>
          <li className='story__content'>
            <div className='story__body'>
              <h3 className='story__text'>Автостопом в Стамбул</h3>
            ...
            <img className='story__image' src={story_3} alt='story photo-3' />
          </li>
        </ul>
      </div>
    </section>
